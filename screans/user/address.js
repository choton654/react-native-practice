  ...
  return (
    <View style={{ flex: 1, margin: "auto" }}>
      <Text
        ...
        To order your products, please enter your address here. We will send
      ...
      <View style={{ flex: 1, marginHorizontal: 20, marginVertical: 10 }}>
        ...
        <TextField
          ...
          name='postalcode'
          variant='outlined'
          value={route ? oldAddress?.postalCode : postalCode}
          style={{
            maxWidth: "90%",
            margin: "auto",
          }}
        ...
        <TouchableOpacity
          ...
          onPress={addAddress}>
          <Text style={{ margin: "auto", fontWeight: "bold", color: "white" }}>
            Save Address
          </Text>
        </TouchableOpacity>
      </View>
