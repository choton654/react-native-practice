  ...
  return (
    <View style={{ flex: 1 }}>
      {user?.address.length === 0 ? (
        ...
        <View style={{ maxWidth: "100%", height: 215 }}>
          <Paper
            style={{
              display: "flex",
            ...
            <Text
              style={{ fontSize: 16, marginHorizontal: 20, marginVertical: 5 }}>
              {user?.address[0].address}-{user?.address[0].postalCode}
            </Text>
            <Text
              style={{ fontSize: 16, marginHorizontal: 20, marginBottom: 20 }}>
              {user?.address[0].contactNo}
            </Text>
            <TouchableOpacity
              style={{
                width: "90%",
              ...
              onPress={() =>
                navigation.navigate("AddLocation", { address: user?.address })
              }>
              <Text
            ...
            cartstate.cart.cartItem.map((item) => (
              <View
                ...
                <Image
                  source={{
                    uri: `${BASE_URL}${
                      item.productId.photo && item.productId.photo[0].img
                    }`,
                  }}
                  style={{
                    width: 50,
        ...
        <View
          ...
          <View style={{ marginHorizontal: 20, flexDirection: "column" }}>
            <Text style={{ fontSize: 20 }}>
              ₹{cartstate.cart && cartstate.cart.price}
            </Text>
